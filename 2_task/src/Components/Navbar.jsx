...
export const Navbar = () => {
    return (
        <div className="navbar">
            ...
            <div className="menu">
                <div className="section"><a href="">Услуги</a></div>
                <div className="section"><a href="">Виджеты</a></div>
                <div className="section"><a href="">Интеграции</a></div>
                <div className="section"><a href="">Кейсы</a></div>
                <div className="section"><a href="">Сертификаты</a></div>
            </div>
